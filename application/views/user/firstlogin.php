	...
	<div class="row">
		...
		<div class="main_container firstlogin">
		    <div class="ibox-content">
				<form action="<?php echo base_url() ?>user/firstloginsubmit" method="POST" class="edit_form first_login_form form-horizontal" enctype='multipart/form-data'>
					...
					<div class="hr-line-dashed"></div>
		            <div class="form-group"><label class="col-sm-2 control-label"><?php echo $this->lang->line('your_main_photo'); ?></label>
		
		                <div class="col-sm-10">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; min-height: 100px; display: none;"></div>
								<div class="fl_btn_upload">
									<span class="btn btn-danger btn-file btn-sm">
									<span class="fileinput-new"><span class="fui-image"></span> <i class="fa fa-upload"></i> <?php echo $this->lang->line('select_a_photo'); ?></span>
									<span class="fileinput-exists"><span class="fui-gear"></span>  <?php echo $this->lang->line('change_photo'); ?></span>
										<input type="file" name="photomain" class="photomain_up">
									</span>
									<a href="#" class="btn btn-primary btn-embossed fileinput-exists" data-dismiss="fileinput"><span class="fui-trash"></span>  <?php echo $this->lang->line('remove_photo'); ?></a>
								</div>
							</div>
		                </div>
		            </div>
