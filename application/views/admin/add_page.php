...
<div class="col-lg-12 block_form">
    <div class="ibox-content-no-bg">
	    ...
	    <div class="alert alert-info alert-centered">
		    Please provide the informations of your new custom page.
	    </div>
	    ...
	    <div class="form-group">
			...
			<div class="controls">
				<input type="text" id="inputTitle" placeholder="Write the title of this custom page" class="form-control" name="title" value="<?php echo set_value('title'); ?>">
			</div>
	    </div>
	    <div class="form-group">
	    	<label class="control-label" for="inputContent">Content</label>
			<div class="controls">
				<textarea id="inputContent" name="content"><?php echo set_value('content'); ?></textarea>
			</div>
	    </div>
	    <div class="form-group">
	    	<label class="control-label" for="inputIcon">Icon</label>
			<div class="controls">
				<input type="text" id="inputIcon" placeholder="Paste the icon name from FontAwesome" class="form-control" name="icon" value="<?php echo set_value('icon'); ?>">
		...
		<div class="checkbox">
			<label>
				<input type="checkbox" name="show_on_welcome" value="1"> Show on welcome / login page
			</label>
	    ...
	    <div style="text-align:center;" class="clearfix">
	    	<button type="submit" class="btn btn-primary btn-large btn-embossed"><i class="fa fa-check"></i> Create Page</button>
	    </div>
		<?php echo form_close(); ?>
    </div>
</div>
