$(document).ready(function() {
	...
	$(".btn-send-and-begin").click(function(e) {
		...
		$.ajax({
			url: base_url + "user/firstloginveriffb",
			type: 'POST',
			beforeSend: beforeSubmit,
			data: {username: username, birthday_day: birthday_day, birthday_month: birthday_month, birthday_year: birthday_year, about_you_txt: about_you_txt, country: country, city: city},
